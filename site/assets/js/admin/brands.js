    ...
    tableBody.innerHTML = brands.map(function (b) {
      ...
      return '<tr class="border-b border-slate-700 hover:bg-slate-700/30">' +
        ...
        '<td class="px-3 py-3 whitespace-nowrap">' +
          '<button class="btn-link-brand mr-2 edit-btn" data-id="' + b.id + '"><span class="material-symbols-outlined text-sm">edit</span><span class="hidden md:inline">Editar</span></button>' +
          '<button class="btn-link-danger delete-btn" data-id="' + b.id + '"><span class="material-symbols-outlined text-sm">delete</span><span class="hidden md:inline">Eliminar</span></button>' +
        '</td>' +
      '</tr>';
    }).join("");
