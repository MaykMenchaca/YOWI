    ...
    tableBody.innerHTML = products.map(function (p) {
      return '<tr class="border-b border-slate-700 hover:bg-slate-700/30">' +
        ...
        '<td class="px-3 py-3 whitespace-nowrap">' +
          '<button class="btn-link-brand mr-2 edit-btn" data-id="' + p.id + '"><span class="material-symbols-outlined text-sm">edit</span><span class="hidden md:inline">Editar</span></button>' +
          '<button class="btn-link-danger delete-btn" data-id="' + p.id + '"><span class="material-symbols-outlined text-sm">visibility_off</span><span class="hidden md:inline">Ocultar</span></button>' +
        '</td>' +
      '</tr>';
    }).join("");
